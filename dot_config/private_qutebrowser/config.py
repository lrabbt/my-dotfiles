...
config.bind('\\f', 'spawn --userscript getfeed')

config.bind('\\mm', 'spawn mpv {url}')
config.bind('\\md', 'spawn yt-dlp --paths ~/Downloads/qutebrowser {url}')
config.bind('\\mu', 'spawn umpv {url}')
config.bind('\\;m', 'hint links spawn umpv {hint-url}')

ask_password_cmd = 'zenity --name zenity-modal --password --title Bitwarden Lock'
ask_domain_cmd = 'wofi --show dmenu --insensitive --prompt Bitwarden'
qute_bitwarden_cmd = f'spawn --userscript qute-bitwarden --password-prompt-invocation "{ask_password_cmd}" --dmenu-invocation "{ask_domain_cmd}"'
config.bind('\\pp', qute_bitwarden_cmd)
config.bind('\\pu', f'{qute_bitwarden_cmd} --username-only')
config.bind('\\po', f'{qute_bitwarden_cmd} --password-only')

config.bind('\\q', 'spawn --userscript qr')

config.bind('\\r', 'spawn --userscript readability')

config.bind('\\t', 'spawn --userscript taskadd')
